<script lang="ts">
    ...
    onMount(async () => {
        ...
        invitations = await $circles.data.getInvitations($wallet.address);
    });
        ...
        <div class="hero-content text-center">
            <div class="max-w-md">
                ...
                {#each invitations as inviter}
                    <p class="btn my-6" on:click={() => acceptInvitation(inviter.avatar)}>
                        by
                        <Avatar clickable={false} address={inviter.avatar}></Avatar>
                    </p>
                {/each}
