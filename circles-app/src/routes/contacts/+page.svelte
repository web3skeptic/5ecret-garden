<script lang="ts">
  ...
  let filterVersion: number | undefined = $state();

  let filteredStore = derived(contacts, ($contacts) => {
...
>
  ...
  <div class="flex flex-row gap-x-2">
    <button
      ...
      onclick={() => (filterVersion = undefined)}
    >
      All
    </button>
    <button
